...
Unmanaged-server-sec-in20k.md is a markdown file discussing Unmanaged Server security, it is essentially a reference guide or long-winded manual. As one might intuit by the file name, it is 20,000 characters of documentation on unmanaged server security. The markdown goes over a 'golden path', environment/infrastructure, operating systems, SSH security, software security (broad), maintenance/lifecycle, and a miscellaneous category. I'm trying to keep it between 20 - 25k characters, I think this is a good size: depth without absurd redundancy and otiose. I think it mainly helps people that are inexperienced with unmanaged server security, however I think even those experienced in cyber security holistically ought to take a look: it's always good to see a new perspective or even some new ideas/tools you hadn't heard of. Security can change a lot, even in just a year.    
